...
cl = TOBY.LINE()
cl.login(token="EnToVGYVMSQxbNLaUI92.dDWM3BCazQ05iUvqLDMZ0G.2MV88CO+mOKz2YegmB2g2Oagua0I7ESXa614Dx+Vp3w")
cl.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u0ddc26ddb70066ad3922e55095d9b3d2"]
admsa = "u0ddc26ddb70066ad3922e55095d9b3d2"
admin = "u0ddc26ddb70066ad3922e55095d9b3d2"
...
#---------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 2000:
                    profile = ki.getProfile()
                    profile.displayName = string
                    cl.updateProfile(profile)
...
#---------------------------------------------------------
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"❂͜͡➣Ini sudah on")
                    else:
                        cl.sendText(msg.to,"Hal ini sudah terbuka ô€¨👈")
                else:
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"❂͜͡➣Hal ini sudah terbuka ô€")
                else:
              ...
              if msg.from_ in admin:
                ...
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"cancelprotect on")
                    else:
                        cl.sendText(msg.to,"")
                else:
                    wait["cancelprotect"] = True
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Qrprotect on")
                    else:
                        cl.sendText(msg.to,"")
                else:
                    wait["linkprotect"] = True
              ...
              if msg.from_ in admin:
                ...
                else: md+="❂͜͡➣ Contact ➣ X\n"
                if wait["autoJoin"] == True: md+="❂͜͡➣ Auto Join ➣ ✔\n"
                else: md +="❂͜͡➣ Auto Join ➣ X\n"
                if wait["autoCancel"]["on"] == True:md+="❂͜͡➣ Auto cancel:" + str(wait["autoCancel"]["members"]) + "➣ ✔\n"
                else: md+= "❂͜͡➣ Group cancel ➣ X\n"
                if wait["leaveRoom"] == True: md+="❂͜͡➣ Auto leave ➣ ✔\n"
                else: md+="❂͜͡➣ Auto leave ➣ X\n"
                if wait["timeline"] == True: md+="❂͜͡➣ Share ➣ ✔\n"
                else:md+="❂͜͡➣ Share ➣ X\n"
                if wait["autoAdd"] == True: md+="❂͜͡➣ Auto add ➣ ✔\n"
                else:md+="❂͜͡➣ Auto add ➣ X\n"
                if wait["commentOn"] == True: md+="❂͜͡➣ Auto komentar ➣ ✔\n"
                else:md+="❂͜͡➣ Auto komentar ➣ X\n"
                if wait["protect"] == True: md+="❂͜͡➣ Protect ➣ ✔\n"
                else:md+="❂͜͡➣ Protect ➣ X\n"
                if wait["linkprotect"] == True: md+="❂͜͡➣ Link Protect ➣ ✔\n"
                else:md+="❂͜͡➣ Link Protect ➣ X\n"
                if wait["inviteprotect"] == True: md+="❂͜͡➣ Invitation Protect ➣ ✔\n"
                else:md+="❂͜͡➣ Invitation Protect ➣ X\n"
                if wait["cancelprotect"] == True: md+="❂͜͡➣ Cancel Protect ➣ ✔\n"
                else:md+="❂͜͡➣ Cancel Protect ➣ X\n"
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to, "Siap Untuk Di Cek")
                    try:
...
#------------------------------------------------------------------
 ...
 #------------------------------------------------------------------
              ...
              if msg.toType == 2:
                ...
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    cl.sendText(msg.to,"「❂͜͡➣ Succes Clear Blacklist ❂͜͡➣」")
...
#----------------------------------------------
                ...
                cl.sendText(msg.to, "「❂͜͡➣ Succes Restared ❂͜͡➣ 」")
                restart_program()
                print "@Restart"
#-----------------------------------------------
            elif msg.text in ["."]:
...
#-----------------------------------------------
                ...
                ki2.sendText(msg.to,"Owner Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
            ...
            elif msg.text.lower() == 'devil':
                ki.sendText(msg.to,"❂͜͡➣DΣVIL TΣΔM βΩT❂͜͡➣")
                ki2.sendText(msg.to,"❂͜͡➣DΣVIL TΣΔM βΩT❂͜͡➣")
                ki3.sendText(msg.to,"❂͜͡➣DΣVIL TΣΔM βΩT❂͜͡➣")
                ki4.sendText(msg.to,"❂͜͡➣DΣVIL TΣΔM βΩT❂͜͡➣")
                ki5.sendText(msg.to,"❂͜͡➣DΣVIL TΣΔM βΩT❂͜͡➣")
                ki6.sendText(msg.to,"❂͜͡➣DΣVIL TΣΔM βΩT❂͜͡➣")
#----------------------------------------------- 
#-----------------------------------------------
        if op.type == 19:
            try:
